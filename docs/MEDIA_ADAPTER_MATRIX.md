...
| candidate promo / newsroom video | `MagicFitProviderAdapter` | fail-closed candidate lane only; no publish authority until verification, watermark/commercial-use proof, motion/people-action QA, public-safety scan, and human creative review pass | runtime-owned | runtime-owned | MagicFit may render candidate B-roll, faction promo scenes, and short photoreal anchor tests only. It may not publish directly or become product proof. |
