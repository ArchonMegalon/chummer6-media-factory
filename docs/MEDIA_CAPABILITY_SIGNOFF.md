...
- GM prep packets via `GmPrepPacketRenderRequest`, `GmPrepPacketBundleReceipt`, `GmPrepPacketEntryReceipt`, `GmPrepPacketSubjectReceiptGroup`, `GmPrepPacketArtifactReceipt`, `GmPrepOppositionPacket`, `GmPrepOppositionPreview`, `GmPrepOppositionBriefing`, `GmPrepScenePacket`, `GmPrepScenePreview`, `GmPrepSceneBriefing`, `GmPrepLibraryPacket`, `GmPrepLibraryPreview`, and `GmPrepLibraryBriefing`
