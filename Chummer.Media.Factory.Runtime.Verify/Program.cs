...
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("JSON exchange:", StringComparison.Ordinal)), "Creator publication planner should preserve JSON exchange parity evidence from the governed build handoff.");
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("Foundry exchange:", StringComparison.Ordinal)), "Creator publication planner should preserve Foundry exchange parity evidence from the governed build handoff.");
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("Sheet viewer:", StringComparison.Ordinal)), "Creator publication planner should preserve sheet-viewer exchange parity evidence from the governed build handoff.");
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("Print PDF:", StringComparison.Ordinal)), "Creator publication planner should preserve print/PDF exchange parity evidence from the governed build handoff.");
...
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("Session recap:", StringComparison.Ordinal)), "Creator publication planner should preserve recap lane evidence from the governed build handoff.");
Assert(creatorPublicationPlan.EvidenceLines.Any(static line => line.Contains("Run module:", StringComparison.Ordinal)), "Creator publication planner should preserve run-module lane evidence from the governed build handoff.");
